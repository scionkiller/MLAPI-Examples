...
namespace Alpaca.Transports.UNET
{
    public static class RelayTransport
    {
        ...
        public static bool Enabled => AlpacaNetwork.GetSingleton().config.RelayEnabled;
        public static string RelayAddress => AlpacaNetwork.GetSingleton().config.RelayAddress;
        public static ushort RelayPort => AlpacaNetwork.GetSingleton().config.RelayPort;

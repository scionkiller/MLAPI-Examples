...
namespace Alpaca.Serialization
{
    ...
    public class BitReader
    {
        ...
        /// </summary>
        /// <returns>Value read from stream.</returns>
        public ushort ReadUInt16() => (ushort)((uint)ReadByte() | ((uint)ReadByte() << 8));
        /// <summary>
        ...
        /// </summary>
        /// <returns>Value read from stream.</returns>
        public uint ReadUInt32() => (uint)((uint)ReadByte() | ((uint)ReadByte() << 8) | ((uint)ReadByte() << 16) | ((uint)ReadByte() << 24));
        /// <summary>
        ...
        public ulong ReadUInt64Packed()
        {
            ...
            if (header == 249) return 2288UL + ((ulong)ReadByte() << 8) + ReadByte();
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        ...
        public byte[] ReadByteArray(byte[] readTo = null, long knownLength = -1)
        {
            ...
            for (long i = 0; i < knownLength; ++i) readTo[i] = ReadByte();
            return readTo;
        }

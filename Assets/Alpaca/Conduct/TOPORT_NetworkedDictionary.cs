...
namespace Alpaca.NetworkedVar.Collections
{
	...
	public class NetworkedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, NetVarInterface
	{
		/// <summary>
		...
		{
			dirtyEvents.Clear();
			LastSyncedTime = AlpacaNetwork.GetSingleton().NetworkTime;
		}
		...
		/// <inheritdoc />
		public void ReadDelta( PooledBitReader reader, bool keepDirtyDelta )
		{
		...
		/// <inheritdoc />
		public void ReadField( PooledBitReader reader )
		{
			dictionary.Clear();
		...
		/// <inheritdoc />
		public void SetConduct(Conduct behaviour)
		{
			Conduct = behaviour;
		}
		...
		/// <inheritdoc />
		public void WriteDelta( PooledBitWriter writer )
		{
		...
		/// <inheritdoc />
		public void WriteField( PooledBitWriter writer )
		{
		...
		public bool IsDirty()
		{
			...
			if (AlpacaNetwork.GetSingleton().NetworkTime - LastSyncedTime >= (1f / Settings.SendTickrate)) return true;
			return false;
		}
		...
		public TValue this[TKey key]
		{
			...
			set
			{
				...
				if (AlpacaNetwork.GetSingleton().IsServer && OnDictionaryChanged != null)

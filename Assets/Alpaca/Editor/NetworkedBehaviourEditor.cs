...
namespace UnityEditor
{
    ...
    [CustomEditor(typeof(Conduct), true)]
    [CanEditMultipleObjects]
    public class ConductEditor : Editor
    {
        ...
        void RenderNetworkedVar(int index)
        {
            ...
            if (value == null)
            {
                ...
                NetVarInterface var = (NetVarInterface) Activator.CreateInstance(fieldType, true);
            ...
            {
                MethodInfo method = typeof(ConductEditor).GetMethod("RenderNetworkedVarValueType", BindingFlags.Public | BindingFlags.Instance | BindingFlags.FlattenHierarchy | BindingFlags.NonPublic);
        ...
        void RenderNetworkedVarValueType<T>(int index) where T : struct
        {
            ...
            if (AlpacaNetwork.GetSingleton() != null && AlpacaNetwork.GetSingleton().IsListening)
            {
                if (type == typeof(int))

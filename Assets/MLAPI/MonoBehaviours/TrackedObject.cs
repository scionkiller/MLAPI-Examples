...
namespace Alpaca
{
    ...
    public class TrackedObject : MonoBehaviour
    {
        ...
        private int maxPoints
        {
            get
            {
                return (int)(NetworkingManager.GetSingleton().config.SecondsHistory / (1f / NetworkingManager.GetSingleton().config.EventTickrate));
            }
        }
        ...
        internal void ReverseTransform(float secondsAgo)
        {
            ...
            float currentTime = NetworkingManager.GetSingleton().NetworkTime;
        ...
        internal void AddFrame()
        {
            ...
            FrameData.Add(NetworkingManager.GetSingleton().NetworkTime, new TrackedPointData()
            {
                position = transform.position,
                rotation = transform.rotation
            });
            Framekeys.Enqueue(NetworkingManager.GetSingleton().NetworkTime);
        }
    }
}

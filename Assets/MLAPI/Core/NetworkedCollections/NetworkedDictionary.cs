...
namespace MLAPI.NetworkedVar.Collections
{
    ...
    public class NetworkedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, INetworkedVar
    {
        ...
        {
            dirtyEvents.Clear();
            LastSyncedTime = NetworkingManager.GetSingleton().NetworkTime;
        }
        ...
        public bool IsDirty()
        {
            ...
            if (NetworkingManager.GetSingleton().NetworkTime - LastSyncedTime >= (1f / Settings.SendTickrate)) return true;
            return false;
        }
        ...
        public TValue this[TKey key]
        {
            ...
            set
            {
                ...
                if (NetworkingManager.GetSingleton().IsServer && OnDictionaryChanged != null)

...
namespace Alpaca.Transports.UNET
{
    public static class RelayTransport
    {
        ...
        public static bool Enabled => NetworkingManager.GetSingleton().config.RelayEnabled;
        public static string RelayAddress => NetworkingManager.GetSingleton().config.RelayAddress;
        public static ushort RelayPort => NetworkingManager.GetSingleton().config.RelayPort;

...
namespace MLAPI.Components
{
    ...
    public class SceneSwitchProgress
    {
        ...
        /// </summary>
        public float TimeAtInitiation { get; } = NetworkingManager.GetSingleton().NetworkTime;
        /// <summary>
        ...
        {
            timeOutCoroutine = NetworkingManager.GetSingleton().StartCoroutine(NetworkingManager.GetSingleton().TimeOutSwitchSceneProgress(this));
        }
        ...
        {
            if (!isCompleted && DoneClients.Count == NetworkingManager.GetSingleton().ConnectedClientsList.Count && sceneLoadOperation.isDone)
            {
                isCompleted = true;
                ...
                NetworkingManager.GetSingleton().StopCoroutine(timeOutCoroutine);
            }
        }
